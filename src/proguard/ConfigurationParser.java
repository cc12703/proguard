...
public class ConfigurationParser
{
    ...
    throws ParseException, IOException
    {
        while (nextWord != null)
        {
            ...
            else if (ConfigurationConstants.USE_UNIQUE_NAMES_OPTION                          .startsWith(nextWord)) configuration.useUniqueNames                   = parseCommaSeparatedList("class name", true, true, false, false, true, false, true, false, configuration.useUniqueNames);
